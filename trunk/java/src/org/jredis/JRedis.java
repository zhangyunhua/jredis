...
//	public boolean auth (String authorization) throws RedisException;
	/**
...
//	public int incr (String key) throws RedisException;
	public long incr (String key) throws RedisException;
//	public int incrby (String key, int delta) throws RedisException;
	public long incrby (String key, int delta) throws RedisException;
//	public int decr (String key) throws RedisException;
//	public int decrby (String key, int delta) throws RedisException;
...
//	public int lrem (String listKey, byte[] value, int count) throws RedisException;
//	public int lrem (String listKey, String stringValue, int count) throws RedisException;
//	public int lrem (String listKey, Number numberValue, int count) throws RedisException;
//	public <T extends Serializable> 
//		   int lrem (String listKey, T object, int count) throws RedisException;
...
//	public int llen (String listkey) throws RedisException;
...
//	public int scard (String setKey) throws RedisException;	
